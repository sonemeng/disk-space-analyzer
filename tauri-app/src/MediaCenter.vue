...
<template>
  <div class="media-center">
    ...
    <template v-if="result">
      ...
      <section class="media-toolbar panel">
        <div class="media-kind-tabs"><button v-for="item in [{ id: 'all', label: '全部' }, { id: 'image', label: '图片' }, { id: 'video', label: '视频' }, { id: 'audio', label: '音频' }]" :key="item.id" :class="{ active: selectedKind === item.id }" @click="selectedKind = item.id as typeof selectedKind">{{ item.label }}</button></div>
